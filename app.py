...
class GeminiSummarizer:
    ...
    def _create_summary_prompt(self, text: str, length: str, style: str = 'neutral') -> str:
...
요약:"""
    ...
    def gemini_summarize(self, text: str, length: str = 'medium', style: str = 'neutral') -> Dict:
        ...
        settings = {'length': length, 'style': style, 'model': 'gemini-pro'}
...
def summarize_url():
    ...
    try:
        ...
        if use_ai and GOOGLE_API_KEY:
            ...
            summary_method = f"AI 요약 (Gemini Pro)" if result['success'] else "추출 요약 (AI 실패로 대체)"
        else:
...
if __name__ == '__main__':
    if not GOOGLE_API_KEY:
        ...
        print("   Google AI Studio(https://aistudio.google.com)에서 API 키를 발급받으세요.")
    else:
